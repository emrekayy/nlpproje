  ...
  return (
    <main className="flex min-h-[60vh] items-center justify-center">
      <div className="max-w-md rounded-3xl border border-slate-200 bg-white/90 p-8 text-center shadow-soft">
        ...
        <h1 className="mt-3 text-3xl font-semibold text-slate-950">Urun yuklenemedi</h1>
        <p className="mt-4 text-sm leading-6 text-slate-600">
          Bu urun icin veriler alinirken bir sorun olustu. Backend servisinin calisir durumda oldugunu kontrol edin.
        </p>
